...
public class EmployeTest {
    ...
    public void augmenterSalaireTestPositif() {
        ...
        Employe employe = new Employe("Pinkman", "Jesse", "M15697", LocalDate.now(), 1000d, 1, 1.0);
    ...
    public void getNbCongesTest(Integer nbAnneeAnciennete, Integer resultat) {
        ...
        Employe employe = new Employe("Pinkman", "Jesse", "M15697", LocalDate.now().minusYears(nbAnneeAnciennete), 1000d, 1, 1.0);
